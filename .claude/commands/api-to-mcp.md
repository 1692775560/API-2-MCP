...
5. If this project is not present locally, use the GitHub package with `npx --yes @api2mcp/cli`.
...
- Run `api-to-mcp $ARGUMENTS`, where `api-to-mcp` is either `node dist/cli.js` in this repo or `npx --yes @api2mcp/cli`.
