...
5. If this project is not present locally, use the GitHub package with `npx --yes @taozhang123/api-to-mcp`.
...
- Run `api-to-mcp $ARGUMENTS`, where `api-to-mcp` is either `node dist/cli.js` in this repo or `npx --yes @taozhang123/api-to-mcp`.
